...
INSERT INTO cuyahoga_modulesetting (moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES (@moduletypeid, 'COLLAPSIBLE', 'Allow all to be COLLAPSIBLE ', 'System.Boolean', 0, 1)
INSERT INTO cuyahoga_modulesetting (moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES (@moduletypeid, 'ACTIVE_INDEX', 'Open index. false = closed. (COLLAPSIBLE yes)', 'System.String', 0, 0)
INSERT INTO cuyahoga_modulesetting (moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES (@moduletypeid, 'AUTO_HEIGHT', 'Use Tallest item height for all items.', 'System.Boolean', 0, 1)
INSERT INTO cuyahoga_modulesetting (moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES (@moduletypeid, 'CLEAR_STYLE', 'Clear height/overflow css (AUTO_HEIGHT no)', 'System.Boolean', 0, 1)
