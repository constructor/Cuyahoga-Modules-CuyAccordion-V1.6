    ...
    <body>
        ...
        <div class="AdminPanel">
            ...
            <div id="accordioniteminfo" class="Panel60">
                ...
                <hr />
                <asp:GridView ID="gvAccordionItems" runat="server" 
                    DataKeyNames="AccordionItemId" AutoGenerateColumns="False" 
                    onrowcancelingedit="gvAccordionItems_RowCancelingEdit" 
                    onrowdeleting="gvAccordionItems_RowDeleting" 
                    onrowediting="gvAccordionItems_RowEditing" 
                    onrowupdating="gvAccordionItems_RowUpdating" 
                    onrowcommand="gvAccordionItems_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnMoveUp" runat="server" CausesValidation="False" CommandName="MoveUp" CommandArgument='<%# Bind("AccordionItemId") %>' Text="Move Up"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnMoveDown" runat="server" CausesValidation="False" CommandName="MoveDown" CommandArgument='<%# Bind("AccordionItemId") %>' Text="Move Down"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
